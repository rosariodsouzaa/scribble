...
const TOP_WARRIORS = [
  ...
  { rank: 4, name: "Kaelen", title: "Dragon Slayer", score: 3240, wins: 18, matches: 26, winRate: "69%", color: "#8b5cf6" },
  { rank: 5, name: "Aria", title: "Lightning Brush", score: 2950, wins: 16, matches: 24, winRate: "66%", color: "#06b6d4" },
  { rank: 6, name: "Ryu", title: "Shadow Ronin", score: 2640, wins: 14, matches: 22, winRate: "63%", color: "#10b981" },
  ...
  return (
    <div className="leaderboard-page">
      <div className="leaderboard-header">
        ...
        <p>Top artists and riddle decipherers of Season 4. Earn victory points to ascend the dragon ranks.</p>
      </div>
