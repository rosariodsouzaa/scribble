 ...
 * Encapsulates the inventory of available relics, cosmetics, and Web3 crypto token gold packs.
 */
export class StoreCatalog {
  constructor() {
    this.items = [
      // Gold Bundles (Purchasable with Web3 Tokens)
      new StoreItem({
        id: "gold_5000",
        category: "gold",
        name: "Novice Pouch",
      ...
      // Season Pass (Purchasable with Web3 Tokens)
      new StoreItem({
        id: "season4_pass",
        category: "pass",
